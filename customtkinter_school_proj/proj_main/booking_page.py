...
class Booking(ctk.CTk):
    ...
    def description(self):
        content = 'Type: reg (regular), gov or staff\nEnter "admin" into all fields to remove a seat if the performance requires or all to bring up all bookings'
...
#----------------------------------------------------------------------------------------------------------------
    ...
    def enter_details(self):
        ...
        qr_filepath = create_qr(name=name, cust_type=cust_type, phone=phone, performance=performance, seats=seats_str, price_paid=price_paid)
